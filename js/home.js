$(document).ready(function()
{
	...
	$.ajax({
			type: "POST",
			url : "http://202.162.209.216/mobility/mobility_controller/display_home_summary",
	...
	$.ajax({
			type: "POST",
			url : "http://202.162.209.216/mobility/mobility_controller/display_login_information",
			data : "curr_date="+curr_date,
			dataType: "json",
			success: function(msg,string,jqXHR)
			{

	$(document).ready(function()
	{
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_bank/"+start_date+"/"+end_date,
		dataType: "json",
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_switching/"+start_date+"/"+end_date,
		dataType: "json",
		success: function(result)
		{
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_switching_total/"+start_date+"/"+end_date,
		dataType: "json",
		success: function(result)
		{
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_merchant/"+start_date+"/"+end_date,
		dataType: "json",
		success: function(result)
		{
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_merchant_total/"+start_date+"/"+end_date,
		dataType: "json",
		success: function(result)
		{
		...
		$.ajax({
		type: "POST",
		url : "http://202.162.209.216/mobility/mobility_controller/display_online_bank_total/"+start_date+"/"+end_date,
		dataType: "json",
		success: function(result)
		{

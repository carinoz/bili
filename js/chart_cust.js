	...
	// when I want to reset my data I call
		...
		$("#button").click(function() // function searching button
		{
			...
			$.ajax({
				type: "POST",
				url : "http://pln.ifabula.com/mobility_controller/search_cust_data/"+a+"/"+end_date,
		...
		/*$(function() {
		 ...
		 $.getJSON("http://pln.ifabula.com/mobility_controller/populate_dropdown_region", function (result) 
		{
			$.each(result, function(i, option) {
				$('#region').append($('<option/>').attr("value", option.region_id).text(option.region_name));
										...
										/*$.ajax({
											type: "POST",
											url : "http://pln.ifabula.com/mobility_controller/display_customer_trans",
		...
		$.getJSON("http://pln.ifabula.com//mobility_controller/display_customer_trans_region", function (result) 
		{	
			var labels = [],data_prepaid=[],data_postpaid=[];
			for (var item in result){
		...
		$.getJSON("http://pln.ifabula.com//mobility_controller/display_customer_trans_daya", function (result) 
		{	
			var labels = [],data_prepaid=[],data_postpaid=[];
			for (var item in result){
				  labels.push(result[item].region_name.toString());
		...
		$.getJSON("http://pln.ifabula.com//mobility_controller/display_customer_trans_kwh", function (result) 
		{	
			var labels = [],data_prepaid=[],data_postpaid=[];
			for (var item in result){
				  labels.push(result[item].region_name.toString());

	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_daya_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_jumlah_pelanggan_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	success: function(result)
	{
		var labels = [],total=[];
	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_kwh_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	success: function(result)
	{
		var labels = [],total=[];
	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_bank_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	success: function(result)
	{
		var labels = [],total=[];
	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_merchant_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	success: function(result)
	{
		var labels = [],total=[];
	...
	({
	type: "POST",
	url : "http://202.162.209.216/mobility/mobility_controller/display_switching_terbesar/"+start_date+"/"+end_date,
	dataType: "json",
	success: function(result)
	{
		var labels = [],total=[];
